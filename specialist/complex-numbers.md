...
* _multiplying and dividing:_
  * ![](../.gitbook/assets/image_1.b235a270.png)
* _de moivre's theorem:_
  ...
  * _proving triple-angle identities:_
    * ![](../.gitbook/assets/image_2.156f1a28.png)

## **argand plane**

#### _geometric question_

* ![](../.gitbook/assets/image_3.da8ec582.png)

#### _loci_

* ![](../.gitbook/assets/image_4.2b9ad501.png)
* ![](../.gitbook/assets/image_5.b3cc7a66.png)
* ![](../.gitbook/assets/image_6.4a4ec6c2.png)
* ![](../.gitbook/assets/image_7.2da05688.png)
...
* i.e. determine all 3 solutions to $${\mathrm{z}}^{3}=1$$
  * ![](../.gitbook/assets/image_8.b0bb90ab.png)
* _sum and product:_
  * ![](../.gitbook/assets/image_9.5ef3450d.png)
  * i.e. for solutions of $${\mathrm{z}}^{\mathrm{n}}=1$$:
    * $$\sum_{k=0}^{n-1} z_k = 0$$
    * $$\prod_{k=0}^{n-1} z_k = (-1)^{n-1}$$
* _complex_ $$n^{th}$$ _roots:_
  * _i.e._ a solution to $${z}^{5}=-4+4i$$ is $$z=1-i$$. find all solutions.
    * ![](../.gitbook/assets/image_10.1bfb698d.png)
