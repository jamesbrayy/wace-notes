...
![](../.gitbook/assets/image_1.a2a38ccd.png)
...
* _i.e._ it is normal to the plane containing $$\underset{\sim}{{a}}$$ and $$\underset{\sim}{{b}}$$ $$\left|\underset{\sim}{{a}}\times \underset{\sim}{{b}}\right|=\left|\underset{\sim}{{a}}\right|\left|\underset{\sim}{{b}}\right|\mathrm{sin}\mathit{\theta}$$, where $$\theta$$is the angle between $$\underset{\sim}{{a}}$$ and $$\underset{\sim}{{b}}$$
...
![](../.gitbook/assets/image_2.7bab86df.png)
...
![](../.gitbook/assets/image_3.57965e1e.png)
...
![](../.gitbook/assets/image_4.9942acb4.png)
...
![](../.gitbook/assets/image_5.ca78936e.png)
...
![](../.gitbook/assets/image_6.d2f641e0.png)
...
![](../.gitbook/assets/image_7.49b6a461.png)

3. conduct back-substitution to solve for variables

![](../.gitbook/assets/image_8.5d9d05cd.png)
...
5. planes intersecting at a point
   ...
   * _i.e._ $${\underset{\sim}{n}}_{1}\cdot \left({\underset{\sim}{n}}_{2}\times {{\underset{\sim}{n}}_{3}}\right)\ne 0$$
   * note that cases 1,2, and 3 have no simultaneous solution as no point lies on all three planes at once
...
![](../.gitbook/assets/image_9.d0e0c80b.png)

#### _plane to point:_

![](../.gitbook/assets/image_10.1e6361a2.png)

#### _line to line:_

![](../.gitbook/assets/image_11.0adeadff.png)
