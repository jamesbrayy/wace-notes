...
* ![](../.gitbook/assets/image_1.d02ac0d7.png)
...
#### 1. _oxidation of_ $$SO_2$$ _to_ $$SO_3$$
...
* flow chart:
  * ![](../.gitbook/assets/image_2.927e1bdd.png)
...
* ![](../.gitbook/assets/image_3.a15be0c0.png)
* the reduced temperatures and pressures for fermentation result in a significant saving in costs, compared to the hydration of ethene
  * the advantage of producing ethanol from the hydration of ethene is that the reaction has **no byproducts**, so the products are only ethanol and water
...
* biodiesel can be made through a number of different methods
  * ![](../.gitbook/assets/image_4.81f28763.png)
...
* _atom economy:_
  ...
  * the higher the atom economy, the 'greener' the process $$\mathrm{atom \; economy} = \frac{M_{\mathrm{desired}}}{\sum M} \times 100$$
